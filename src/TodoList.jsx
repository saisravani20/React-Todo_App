    ...
    //                         </select>
    //                         <button
    //                         className={`bg-${ editingTask ? "teal-500" : "blue-500"} hover:bg-${editingTask ? "green-700" : "blue-700"} text-white py-2 px-4 rounded`}
    //                         type="submit" 
    //                         >
            ...
            <div className="my-4">
                    <form onSubmit={editingTask ? handleSave : handleAdd}>
                        <div className="flex">
                            ...
                            <button
                            className={`bg-${ editingTask ? "blue-500" : "blue-500"} hover:bg-${editingTask ? "blue-700" : "blue-700"} text-white py-2 px-4 rounded`}
                            type="submit"
                            >
                            {editingTask ? "Save" : "Add"}
                            </button>
